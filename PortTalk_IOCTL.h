...
#define IOCTL_PARALLEL_PORT_GET_DEVICE_OBJECT \
    CTL_CODE(PORTTALK_TYPE, 0x910, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PARALLEL_PORT_FREE_DEVICE_OBJECT \
    CTL_CODE(PORTTALK_TYPE, 0x911, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PARALLEL_PORT_ALLOCATE \
    CTL_CODE(PORTTALK_TYPE, 0x912, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PARALLEL_PORT_FREE \
    CTL_CODE(PORTTALK_TYPE, 0x913, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PRIV_CMND_RDMSR \
    CTL_CODE(PORTTALK_TYPE, 0x920, METHOD_BUFFERED, FILE_ANY_ACCESS)
